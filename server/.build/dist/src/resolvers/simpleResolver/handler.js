 ...
 */
var simpleQuery = "\n\tquery($search: String!) {\n\t  notesList(filter: {\n\t    body: {\n\t      contains: $search\n\t    }\n\t  }) {\n\t  \tcount\n\t  }\n\t}\n";
exports.default = (function (event, ctx) { return __awaiter(void 0, void 0, void 0, function () {
    var resp, errors, search, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, ctx.api.gqlRequest(simpleQuery, { search: search })];
            case 2:
                resp = _a.sent();
                return [3 /*break*/, 4];
            case 3:
